...
// Algorytmy heurystyczne - TS i SA
//---------------------------------------
// Miroslaw Kuzniar
// nr indeksu: 248870
//---------------------------------------
...
int main()
{
   char nazwa_pliku[15];
    ...
    cout << " | 1 - Tabu Search | 2 - Symulowane wyzarzanie | " << endl;
    cout << "-------------------------------------------------" << endl;
    cout << " Rodzaj algorytmu: ";
    cin >> rodzaj_algorytmu;
    cout << "-------------------------------------------------" << endl;

    if (rodzaj_algorytmu == 1)
    {
        for (;;)
        {
            algorytmTS(ilosc_miast, macierz_sasiedztwa); //Implementacja algorytmu Tabu Search 
        }
    }
    else if(rodzaj_algorytmu == 2)
    {
        for (;;)
        {
            algorytmSA(ilosc_miast, macierz_sasiedztwa); //Implementacja algorytmu Symulowanego Wyzarzania
        }
    }
    else
    {
